const { runRulesEngine } = require("./rulesEngine");
const { buildFixActions, buildHeadline } = require("./fixActions");
...
function analyzeCodeLocally(code, language = "python", context = {}) {
...
module.exports = { analyzeCodeLocally };
