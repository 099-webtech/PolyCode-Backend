const { normalizeIssueKey, scanAllStaticIssues } = require("./codeIssueScanner");
...
function buildFixActions(findings = [], context = {}) {
...
function buildHeadline(score, actions, context = {}) {
  const failed =
...
module.exports = { buildFixActions, buildHeadline };
